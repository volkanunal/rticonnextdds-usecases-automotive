...
/* ----------------------------------------------------------------------------
*  Type Helloworld_HelloWordMessage
* -------------------------------------------------------------------------- */
...
Helloworld_HelloWordMessagePluginSupport_create_data_w_params(
    const struct DDS_TypeAllocationParams_t * alloc_params) 
{
    Helloworld_HelloWordMessage *sample = NULL;

    sample = new (std::nothrow) Helloworld_HelloWordMessage ;
    if (sample == NULL) {
        return NULL;
    }

    if (!Helloworld_HelloWordMessage_initialize_w_params(sample,alloc_params)) {
        delete  sample;
        sample=NULL;
    }
    return sample;
...
Helloworld_HelloWordMessagePluginSupport_create_data_ex(RTIBool allocate_pointers) 
{
    ...
    if (!Helloworld_HelloWordMessage_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
        delete  sample;
        sample=NULL;
    }
...
{
    return Helloworld_HelloWordMessagePluginSupport_create_data_ex(RTI_TRUE);
}
...
Helloworld_HelloWordMessagePluginSupport_destroy_data_w_params(
    ...
    const struct DDS_TypeDeallocationParams_t * dealloc_params) {
    Helloworld_HelloWordMessage_finalize_w_params(sample,dealloc_params);
...
Helloworld_HelloWordMessagePluginSupport_destroy_data_ex(
    ...
    Helloworld_HelloWordMessage_finalize_ex(sample,deallocate_pointers);
...
Helloworld_HelloWordMessagePluginSupport_destroy_data(
    ...
    Helloworld_HelloWordMessagePluginSupport_destroy_data_ex(sample,RTI_TRUE);
...
{
    return Helloworld_HelloWordMessage_copy(dst,(const Helloworld_HelloWordMessage*) src);
}
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        DDS_TypeCodeFactory_get_instance(),
        Helloworld_HelloWordMessage_get_typecode(),
        &programProperty,
        RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
    if (programs == NULL) {
        PRESTypePluginDefaultParticipantData_delete(
    ...
    void *containerPluginContext)
{
    ...
    epd = PRESTypePluginDefaultEndpointData_new(
        ...
        endpoint_info,
        (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
        Helloworld_HelloWordMessagePluginSupport_create_data,
        (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
        Helloworld_HelloWordMessagePluginSupport_destroy_data,
        NULL , NULL );
    ...
    if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
        serializedSampleMaxSize = Helloworld_HelloWordMessagePlugin_get_serialized_sample_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        PRESTypePluginDefaultEndpointData_setMaxSizeSerializedSample(epd, serializedSampleMaxSize);
        ...
        if (PRESTypePluginDefaultEndpointData_createWriterPool(
            ...
            endpoint_info,
            (PRESTypePluginGetSerializedSampleMaxSizeFunction)
            Helloworld_HelloWordMessagePlugin_get_serialized_sample_max_size, epd,
            (PRESTypePluginGetSerializedSampleSizeFunction)
            PRESTypePlugin_interpretedGetSerializedSampleSize,
            epd) == RTI_FALSE) {
            PRESTypePluginDefaultEndpointData_delete(epd);
...
Helloworld_HelloWordMessagePlugin_return_sample(
    ...
    void *handle)
{
    Helloworld_HelloWordMessage_finalize_optional_members(sample, RTI_TRUE);
...
{
    if (endpoint_data) {} /* To avoid warnings */
    return Helloworld_HelloWordMessagePluginSupport_copy_data(dst,src);
}
    ...
    DDS_DataRepresentationId_t representation)
{
    ...
    plugin.typeCode = (struct RTICdrTypeCode *)
    Helloworld_HelloWordMessage_get_typecode();
    pd.programs = Helloworld_HelloWordMessagePlugin_get_programs();
    if (pd.programs == NULL) {
        return RTI_FALSE;
    }
...
Helloworld_HelloWordMessagePlugin_serialize_to_cdr_buffer(
    ...
    const Helloworld_HelloWordMessage *sample)
{
    return Helloworld_HelloWordMessagePlugin_serialize_to_cdr_buffer_ex(
        buffer,
        length,
        sample,
        DDS_AUTO_DATA_REPRESENTATION);
    ...
    const struct DDS_PrintFormatProperty *property)
{
    ...
    if (!Helloworld_HelloWordMessagePlugin_serialize_to_cdr_buffer(
        NULL, 
        &length, 
        sample)) {
        return DDS_RETCODE_ERROR;
...
RTIBool Helloworld_HelloWordMessagePlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    Helloworld_HelloWordMessage **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *Helloworld_HelloWordMessagePlugin_new(void) 
{ 
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION = 
    PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
    (PRESTypePluginCreateSampleFunction)
    Helloworld_HelloWordMessagePlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    Helloworld_HelloWordMessagePlugin_destroy_sample;
    plugin->finalizeOptionalMembersFnc =
    (PRESTypePluginFinalizeOptionalMembersFunction)
    Helloworld_HelloWordMessage_finalize_optional_members;
    ...
    plugin->getSampleFnc =
    (PRESTypePluginGetSampleFunction)
    Helloworld_HelloWordMessagePlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    Helloworld_HelloWordMessagePlugin_return_sample;
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    Helloworld_HelloWordMessagePlugin_get_key_kind;
    ...
    */
    ...
    plugin->typeCode = NULL; 
    #else
    plugin->typeCode =  (struct RTICdrTypeCode *)Helloworld_HelloWordMessage_get_typecode();
    #endif
    plugin->languageKind = PRES_TYPEPLUGIN_CPP_LANG;
    ...
    plugin->getBuffer = 
    (PRESTypePluginGetBufferFunction)
    Helloworld_HelloWordMessagePlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    Helloworld_HelloWordMessagePlugin_return_buffer;
    plugin->getBufferWithParams = NULL;
    plugin->returnBufferWithParams = NULL;  
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    ...
    plugin->endpointTypeName = Helloworld_HelloWordMessageTYPENAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

void
Helloworld_HelloWordMessagePlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 
